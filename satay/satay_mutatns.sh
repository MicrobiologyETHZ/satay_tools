...
cd /nfs/cds-peta/exports/biol_micro_cds_gr_sunagawa/scratch/Projects_NCCR/other/lheistinger/pheromone_screen/mutant_analysis/bam
...
for i in merged_bams/*.bed; do echo $i; /nfs/cds-peta/exports/biol_micro_cds_gr_sunagawa/scratch/Projects_NCCR/repos/barral_satay/code/src/process_bed.sh $i > $i.insertions; done
